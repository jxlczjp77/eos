...
#define _EXPAND_ARGS(CLS, MOD, INFO)\
   BOOST_PP_CAT(BOOST_PP_OVERLOAD(_REGISTER_INTRINSIC, INFO)( CLS, MOD, INFO ), BOOST_PP_EMPTY())
#else
#define _EXPAND_ARGS(CLS, MOD, INFO)\
...
#define _REGISTER_INTRINSIC(R, CLS, INFO)\
   _EXPAND_ARGS(CLS, "env", _UNWRAP_SEQ INFO)
#else
#define _REGISTER_INTRINSIC(R, CLS, INFO)\
...
#define _REGISTER_INJECTED_INTRINSIC(R, CLS, INFO)\
   _EXPAND_ARGS(CLS, EOSIO_INJECTED_MODULE_NAME, _UNWRAP_SEQ  INFO)
#else
#define _REGISTER_INJECTED_INTRINSIC(R, CLS, INFO)\
